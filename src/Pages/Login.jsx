            ...
            <div className="flex flex-col  items-center justify-center h-screen ">
                <div className="flex flex-col bg-white space-y-8 p-8 w-fit rounded-xl">
                    <div className="space-y-2">
                        <h1 className="text-black/90 text-5xl xl:text-6xl">Log In</h1>
                        <span className="text-black/80 text-xl xl:text-2xl">Don't have an account? <Link to="/Register" className="text-blue-400 text-sm xl:text-xl undeline">Create an account</Link> </span>
                    ...
                    <form className="space-y-4">
                        ...
                        <button className="text-white/95 hover:cursor-pointer bg-blue-500/65 w-fit font-semibold text-md xl:text-xl py-2 px-4 rounded-full">Log in</button>
                    </form>
                </div>
            </div>
        </div>
